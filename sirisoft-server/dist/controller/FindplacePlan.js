...
const FindplacePlan = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const MAP_URL = `https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${output}&details=true&types=shopping_mall&key=AIzaSyBkY8q3PCEZFCjDJrvIO75yHM6d3H-LzQ4&region=th`;
